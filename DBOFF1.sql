...
-- -----------------------------------------------------
-- Table `DBOFF1`.`Db_categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DBOFF1`.`Db_categories` (
  `db_categories_id` INT NOT NULL AUTO_INCREMENT,
  `db_categories` VARCHAR(75) NOT NULL,
  PRIMARY KEY (`db_categories_id`),
  UNIQUE INDEX `categories_UNIQUE` (`db_categories` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `DBOFF1`.`Products` (
  ...
  `Db_categories_db_categories_id` INT NOT NULL,
  PRIMARY KEY (`products_id`, `Codes_products_OFF_Codes_products_OFF_id`, `Brands_brands_id`, `Nutriscore_grade_nutriscore_grade_id`, `Db_categories_db_categories_id`),
  ...
  INDEX `fk_Products_Db_categories1_idx` (`Db_categories_db_categories_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Products_Codes_products_OFF1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Products_Db_categories1`
    FOREIGN KEY (`Db_categories_db_categories_id`)
    REFERENCES `DBOFF1`.`Db_categories` (`db_categories_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
