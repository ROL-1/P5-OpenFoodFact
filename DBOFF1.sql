...
CREATE TABLE IF NOT EXISTS `DBOFF1`.`Products` (
  ...
  PRIMARY KEY (`products_id`, `Codes_products_OFF_Codes_products_OFF_id`, `Brands_brands_id`, `Nutriscore_grade_nutriscore_grade_id`, `Categories_categories_id`),
